...
namespace APC_BarbaraCoscolim_P8_v1.Models
{
    ...
    {
        [System.Web.Mvc.Remote("IfUserExists", "Home", ErrorMessage = "Utilizador já registado.")]
        [Required]
        [EmailAddress]
        [Display(Name = "E-mail")]
        public string Email { get; set; }
        ...
        [Compare("Password", ErrorMessage = "A palavra-passe e sua confirmação não correspondem.")]
